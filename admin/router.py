...
PERMISSION_LABELS = {
    ...
    Permission.MANAGE_PROMO_CODES: "Промокоды",
...
from app.admin.routes import admins, audit, broadcasts, dashboard, payments, promo_codes, referrals, support, tariffs, users, vless_links  # noqa: E402
